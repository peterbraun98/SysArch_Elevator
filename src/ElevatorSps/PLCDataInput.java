...
public class PLCDataInput {
    ...
    public PLCDataInput(boolean[] sensors, boolean[] doorMotor, int elevatorId, int speed, boolean error) {
    ...
    public boolean equals(Object obj) {
        try{
            boolean same = true;
            PLCDataInput input = (PLCDataInput)obj;
